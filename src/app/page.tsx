...
import { Copy, Check, Loader2, Sparkles, Download, Image as ImageIcon, Trash2, FileText, Palette, Wand2, CopyCheck } from "lucide-react";
...
export default function Home() {
  ...
  // Workflow state
  const [workflow, setWorkflow] = useState<"infographic" | "lesson_plan" | "comic">("infographic");
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {workflow === "comic" && (
          <div className="flex flex-col items-center justify-center p-20 bg-white rounded-2xl shadow-sm border border-gray-200 animate-in fade-in">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Quy trình tích hợp truyện tranh</h2>
